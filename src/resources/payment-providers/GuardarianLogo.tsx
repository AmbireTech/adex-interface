  ...
  return (
    ...
    >
      <defs>
        ...
        >
          <stop offset="0.14" stopColor="#1b0067" />
          <stop offset="0.21" stopColor="#251277" />
          <stop offset="0.34" stopColor="#363092" />
          <stop offset="0.48" stopColor="#4347a7" />
          <stop offset="0.62" stopColor="#4c57b6" />
          <stop offset="0.79" stopColor="#5161bf" />
          <stop offset="1" stopColor="#5364c2" />
        </linearGradient>
        <linearGradient
          ...
          gradientUnits="objectBoundingBox"
        >
          <stop offset="0.15" stopColor="#1b0067" />
          <stop offset="0.22" stopColor="#251277" />
          <stop offset="0.35" stopColor="#363092" />
          <stop offset="0.48" stopColor="#4347a7" />
          <stop offset="0.63" stopColor="#4c57b6" />
          <stop offset="0.79" stopColor="#5161bf" />
          <stop offset="1" stopColor="#5364c2" />
        </linearGradient>
        <linearGradient
        ...
        >
          <stop offset="0.14" stopColor="#1b0067" />
          <stop offset="0.53" stopColor="#352e91" />
          <stop offset="1" stopColor="#5364c2" />
        </linearGradient>
        <linearGradient
        ...
        <linearGradient
          ...
          gradientUnits="objectBoundingBox"
        >
          <stop offset="0.18" stopColor="#1b0067" />
          <stop offset="0.24" stopColor="#251277" />
          <stop offset="0.37" stopColor="#363092" />
          <stop offset="0.5" stopColor="#4347a7" />
          <stop offset="0.64" stopColor="#4c57b6" />
          <stop offset="0.8" stopColor="#5161bf" />
          <stop offset="1" stopColor="#5364c2" />
        </linearGradient>
        <linearGradient
          ...
          gradientUnits="objectBoundingBox"
        >
          <stop offset="0" stopColor="#5364c2" />
          <stop offset="1" stopColor="#393698" />
        </linearGradient>
      </defs>
      <path
        id="Path_3103"
        data-name="Path 3103"
        d="M375.6,82.26c2.18,2.91-4.2,8.533-2.769,6.211h-13.6a15.923,15.923,0,0,1-2.969-6.211Z"
        transform="translate(-294.336 -67.962)"
        fill="url(#linear-gradient)"
      />
      <path
        id="Path_3105"
        data-name="Path 3105"
        d="M420.175,82.26a23.143,23.143,0,0,1-1.834,6.52,27.725,27.725,0,0,1-8.079,10.255,10.943,10.943,0,0,1-5.509-.861c-.7-.3-1.756-.9-1.764-1.694a28.05,28.05,0,0,0,2.376-1.564,2.589,2.589,0,0,0,.221-.16A22.6,22.6,0,0,0,414.2,82.269Z"
        transform="translate(-332.943 -67.962)"
        fill="url(#linear-gradient-2)"
      />
      <path
        id="Path_3106"
        data-name="Path 3106"
        d="M367.536,0H338.42V6.237h29.116Z"
      ...
      <path
        id="Path_3104"
        data-name="Path 3104"
        d="M327.215,31.061a35.183,35.183,0,0,1-6.233,3.977l-1.083.542-1.09-.542C308.58,29.907,302.47,21.065,302.47,11.375V0h6.24V11.375a15.6,15.6,0,0,0,.15,2.169c.786,5.887,4.761,11.317,11.011,14.974a.077.077,0,0,0,.021.014l.016-.01.026-.016a22.534,22.534,0,0,0,7.281,2.555Z"
        transform="translate(-249.895)"
